...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002187501114').split()] #Channel id for auto indexing ( make sure bot is admin )
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/Patrick_Botz') # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Patrick_Botz') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ʜᴘ')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002187501114')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/requestmoviesgroup0') #Support group link ( make sure bot is admin )
